...
if(Boost_FIND_VERSION_EXACT)
  ...
  set(_Boost_KNOWN_VERSIONS ${Boost_ADDITIONAL_VERSIONS}
    "1.67.0" "1.67" "1.66.0" "1.66" "166" "1.65.1" "1.65.0" "1.65"
    "1.64.0" "1.64" "164" "1.63.0" "1.63" "1.62.0" "1.62" "1.61.0" "1.61" "1.60.0" "1.60"
...
if(NOT Boost_INCLUDE_DIR)
  ...
  foreach(_boost_VER ${_boost_TEST_VERSIONS})
    ...
    elseif(_boost_VER MATCHES "([0-9]+)\\.([0-9]+)")
        ...
        set(_boost_BOOSTIFIED_VERSION ${_boost_VER})
    endif()
  ...
  set(_boost_CONFIG_NAMES
    "boost/config.hpp")

  find_path(Boost_INCLUDE_DIR
    NAMES         ${_boost_CONFIG_NAMES}
...
if(Boost_INCLUDE_DIR)
  ...
  if(EXISTS "${Boost_INCLUDE_DIR}/boost/version.hpp")
    ...
    file(STRINGS "${Boost_INCLUDE_DIR}/version.hpp" _boost_VERSION_HPP_CONTENTS REGEX "#define BOOST_(LIB_)?VERSION ")
  endif()
...
foreach(COMPONENT ${Boost_FIND_COMPONENTS})
  ...
  if(Boost_USE_DEBUG_LIBS)
    _Boost_FIND_LIBRARY(Boost_${UPPERCOMPONENT}_LIBRARY_DEBUG DEBUG
      ...
      if (Boost_${UPPERCOMPONENT}_LIBRARY_DEBUG)
